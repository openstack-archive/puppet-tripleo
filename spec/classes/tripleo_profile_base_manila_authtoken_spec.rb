...
describe 'tripleo::profile::base::manila::authtoken' do
  shared_examples_for 'tripleo::profile::base::manila::authtoken' do
    context 'with step less than 3' do
      ...
      it {
        ...
        is_expected.to_not contain_class('manila::keystone::authtoken')
      }
    end
