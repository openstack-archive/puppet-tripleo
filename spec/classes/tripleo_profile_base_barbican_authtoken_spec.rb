...
describe 'tripleo::profile::base::barbican::authtoken' do
  shared_examples_for 'tripleo::profile::base::barbican::authtoken' do
    context 'with step less than 3' do
      ...
      it {
        ...
        is_expected.to_not contain_class('barbican::keystone::authtoken')
      }
    end
